...
function Third(props){
    return(
        ...
        <Text style={{paddingVertical: 25, height: 90, fontSize: 31, alignItems:'center', textAlign:'center', color: 'black'}}>Company Login</Text>
        ...
        <View style={{margin: 2}}>
        <Button onPress={()=>props.navigation.navigate("companyMenu")} title="Login"/>
        </View>
        </View>
    )
}
