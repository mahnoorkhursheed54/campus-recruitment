...
function Main(props){
    return(   
        ...
        <Text style={{paddingVertical: 25, height: 90, fontSize: 31, alignItems:'center', textAlign:'center', color: 'black'}}>Main Menu</Text>
        <View style={{margin: 2}}>
        <Button title="Student Deatils"/>
        </View>
        <View style={{margin: 2}}>
        <Button onPress={()=>props.navigation.navigate("companiesList")} title="Company Deatils"/>
        </View>
        </View>
    )
}
